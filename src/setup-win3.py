...
os.system('copy includes\\WenQuanYiZenHei-01.ttf dist')
os.system('copy includes\\SourceHanSansCN-Regular.otf dist')
os.system('copy includes\\SourceHanSansHK-Regular.otf dist')
os.system('copy includes\\SourceHanSansJP-Regular.otf dist')
os.system('copy includes\\SourceHanSansKR-Regular.otf dist')
os.system('copy includes\\SourceHanSansTW-Regular.otf dist')
