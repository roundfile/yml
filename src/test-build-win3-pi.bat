...
rem rem set environment variables for version and build
...
rem 
rem rem create a version file for pyinstaller
...
rem 
rem rem Don't make assumptions as to where the 'makensis.exe' is - look in the obvious places
