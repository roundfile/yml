...
class AillioR1:
    ...
    def __init__(self, debug:bool = False) -> None:
        ...
        self.MAX_PACKET_SIZE = 64  # Standard USB packet size
    ...
    def __open(self) -> None:
        ...
        if not system().startswith('Windows'):
            ...
            if system().startswith('Linux'):
                ...
                for shared_libusb_path in [
                    ...
                    if os.path.isfile(shared_libusb_path):
                        ...
                        libusb10._load_library = _load_library
            ...
            # Windows handling
            for variant in self.DEVICE_VARIANTS:
                self.usbhandle = libusb_package.find(idVendor=variant['vid'],
                                                idProduct=variant['pid'])
                if self.usbhandle is not None:
                    self.protocol = variant['protocol']
                    self.model = variant['model']
                ...
                if self.protocol == 1:
                    ...
                    if len(data) == 64:
                        ...
                        if frame_type == 0xA0:
                            ...
                            self.ibts_ambient = unpack('f', data[12:16])[0]
    ...
    def prepare_command(self, cmd):
        if self.protocol == 2:
            ...
            crc = self.calculate_crc32(cmd_with_crc)
    ...
    def get_ibts_ambient_temp(self) -> int:
        self.__getstate()
    ...
    def r2_cmd(self, str_in) -> None:
        ...
        if command == 'prs':
        ...
        elif command == 'fcstart':
            pass

        elif command == 'fcend':
            pass

        elif command == 'scstart':
            pass
            ...
            if 20 <= temp <= 350:
                ...
                if self.protocol == 2:
                    ...
                    print("Preheat setting only available on R2")
            else:
