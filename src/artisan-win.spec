...
a = Analysis(['artisan.py'],
             ...
             runtime_hooks=[],
             excludes=[],
             hiddenimports=['PyQt6.QtWebChannel','PyQt6.QtWebEngineCore','scipy.spatial.transform._rotation_groups', 'scipy._lib.messagestream','pywintypes','win32cred','win32timezone', 'pkg_resources.markers','scipy.special.cython_special'],
