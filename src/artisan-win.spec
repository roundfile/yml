...
if os.environ.get('APPVEYOR'):
  ...
  ARTISAN_SRC = r'C:\Users\roast\Documents\src'
...
a = Analysis(['artisan.py'],
             ...
             runtime_hooks=[],
             excludes=[],
             hiddenimports=['PyQt6.QtWebChannel','scipy.spatial.transform._rotation_groups', 'scipy._lib.messagestream','pywintypes','win32cred','win32timezone', 'pkg_resources.py2_warn','scipy.special.cython_special'],
