...
if [ -f "$PYLUPDATE" ]; then
    ...
    pylupdate6 -V
    which pylupdate6
    cat -A /Users/appveyor/venv3.11.0/lib/python3.11/site-packages/PyQt6/lupdate/pylupdate.py
    cat -A /Users/appveyor/venv3.11.0/lib/python3.11/site-packages/PyQt6/lupdate/lupdate.py
    echo "*************"
